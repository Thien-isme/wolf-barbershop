    ...
    return (
        <Card
            style={{
                background: '#fff',
                backgroundImage:
                    "url('https://i.pinimg.com/736x/d9/94/af/d994af8bcccddb08943565a3b0e36013.jpg')",
                color: '#111',
                textAlign: 'center',
                borderRadius: 16,
            ...
            bodyStyle={{ padding: 0 }}
            hoverable
            className={`${styles['barber-bubble-card']} ${
                bubble ? styles['bubble-animate'] : ''
            }`}
        >
            ...
            <div
                className={styles['barber-img-wrapper']}
